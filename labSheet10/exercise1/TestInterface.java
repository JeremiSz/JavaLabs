...
public class TestInterface {
     public static void main(String args[]) {
			...
			PermanentLecturer permanentLecturer1 = new PermanentLecturer();
			PermanentLecturer permanentLecturer2 = new PermanentLecturer();

			TemporaryLecturer temporaryLecturer1 = new TemporaryLecturer();
			TemporaryLecturer temporaryLecturer2 = new TemporaryLecturer();

			Person[] people = new Person[] {u1,u2,p1,p2,permanentLecturer1,permanentLecturer2,temporaryLecturer1,temporaryLecturer2};
